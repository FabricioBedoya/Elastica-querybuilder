...
namespace O2\QueryBuilder2\Request;

use O2\QueryBuilder2\Builder\QueryBuilder;
...
class QueryRequest {
     ...
     */
    public static function processRequest(\O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder, array $params, array $mapping, array $json_params, array $query_options) {
...
//        $thematic = $params['thematic'];
    ...
    public static function getFilters(\O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder, array $caracteristics, array $params, array $query_options, array $search_filters = array(), array $search_filter_with_term = array()) {
     ...
     * @return \TQ\QueryBundle\Controller\QueryController
     */
    public static function processMapRequest($queryHandler, \O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder, array $params) {
     ...
     * @return array
     */
    public static function calculateZoomNeedsToBeFound($queryHandler, \O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder, array $parameters) {
    ...
    /**
     * 
     * @param \O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder
     * @param array $parameters
     * @return array $results
     */
    public static function processNearByRequest(\O2\QueryBuilder2\Builder\QueryBuilder $queryBuilder, array $parameters) {
        $max_box = null;
        switch (true) {
