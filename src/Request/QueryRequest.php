...
namespace Fafas\ElasticaQuery\Request;

use Fafas\ElasticaQuery\Builder\QueryBuilder;
...
class QueryRequest {
     ...
     */
    public static function processRequest(\Fafas\ElasticaQuery\Builder\QueryBuilder $queryBuilder, array $params, array $mapping, array $json_params, array $query_options) {
...
//        $thematic = $params['thematic'];
    ...
    public static function getFilters(\Fafas\ElasticaQuery\Builder\QueryBuilder $queryBuilder, array $caracteristics, array $params, array $query_options, array $search_filters = array(), array $search_filter_with_term = array()) {
     ...
     * @return \TQ\QueryBundle\Controller\QueryController
     */
    public static function processMapRequest($queryHandler, \Fafas\ElasticaQuery\Builder\QueryBuilder $queryBuilder, array $params) {
     ...
     * @return array
     */
    public static function calculateZoomNeedsToBeFound($queryHandler, \Fafas\ElasticaQuery\Builder\QueryBuilder $queryBuilder, array $parameters) {
     ...
     */
    public static function processNearByRequest(\Fafas\ElasticaQuery\Builder\QueryBuilder $queryBuilder, array $parameters) {
        $max_box = null;
        switch (true) {
